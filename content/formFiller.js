// Content Script Form Filler Module
// Handles intelligent form filling with resume data

// Prevent multiple loading
if (window.resumeAutoFillFormFillerLoaded) {
  console.log('⚠️ FormFiller module already loaded, skipping...');
} else {
  window.resumeAutoFillFormFillerLoaded = true;
